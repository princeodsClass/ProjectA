...
{
	/** 스크롤러 셀 뷰 */
	public class CLEUIsScrollerCellView : MonoBehaviour
	{
		#region 변수
		...
		[SerializeField] private Button m_oCopyBtn = null;
		[SerializeField] private Button m_oMoveBtn = null;
		...
		public Button CopyBtn => m_oCopyBtn;
