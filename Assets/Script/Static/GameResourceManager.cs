...
public partial class GameResourceManager : SingletonMono<GameResourceManager>
{
	...
	public IEnumerator CoPreloadResource()
	{
	...
	{
		if (IsInitTableData) yield break;
    ...
    public void LoadDataBase(ENTITY_TYPE eType)
    {
        Entity.LoadDataBase(eType.FileName(), eType.TypeName());
    }
	...
	{
		IsInitTableData = false;
		DataBase.Clear();
		GameManager.Log("InitDataBase", "green");
	}
	...
	public string GetPrefabPath(EResourceType eType, string strPrefName, int a_nTheme = 0)
	{
		...
		switch (eType)
		{
			case EResourceType.Character: return $"{ComType.CHARACTER_PATH}{strPrefName}";
			case EResourceType.Weapon: return $"{ComType.WEAPON_PATH}{strPrefName}";
			case EResourceType.Gear: return $"{ComType.GEAR_PATH}{strPrefName}";
			case EResourceType.Box: return $"{ComType.BOX_PATH}{strPrefName}";

			case EResourceType.Object: return $"{ComType.OBJECT_PATH}{strPrefName}";
			case EResourceType.ObjectLevel: return $"{ComType.OBJECT_PATH_LEVEL}{strPrefName}";

			case EResourceType.Effect_BG: return $"{ComType.EFFECT_PATH_BG}{strPrefName}";
			case EResourceType.Effect_CH: return $"{ComType.EFFECT_PATH_CH}{strPrefName}";
			case EResourceType.Effect_UI: return $"{ComType.EFFECT_PATH_UI}{strPrefName}";
			...
			case EResourceType.BG_Walkable: return $"{ComType.G_BG_PATH_WALKABLE}{oThemePath}{strPrefName}";
			case EResourceType.BG_NotWalkable: return $"{ComType.G_BG_PATH_NOT_WALKABLE}{oThemePath}{strPrefName}";
			case EResourceType.BG_Decoration: return $"{ComType.G_BG_PATH_DECORATION}{oThemePath}{strPrefName}";
			case EResourceType.BG_Etc: return $"{ComType.G_BG_PATH_ETC}{strPrefName}";
			case EResourceType.BG_Temp: return $"{ComType.G_BG_PATH_TEMP}{strPrefName}";

			case EResourceType.Character_NPC: return $"{ComType.CHARACTER_PATH}{ComType.CHARACTER_EXTRA_PATH_NPC}{oThemePath}{strPrefName}";
			case EResourceType.UI_Battle: return $"{ComType.UI_PATH_BATTLE}{strPrefName}";
			case EResourceType.BG: return $"{ComType.G_BG_PATH}{strPrefName}";
			case EResourceType.Effect: return $"{ComType.EFFECT_PATH}{strPrefName}";
			case EResourceType.Etc: return $"{ComType.G_ETC_PATH}{strPrefName}";
		}
	...
	{
		if (m_dicCachedObject.ContainsKey(strAudioName))
			return m_dicCachedObject[strAudioName] as AudioClip;

		Object obj = Load<Object>($"{ComType.AUDIO_PATH}{strAudioName}");
		if (null != obj)
		{
			m_dicCachedObject.Add(strAudioName, obj);
